              ...
              <div className="mt-2" style={{ width: 'fit-content', minWidth: '25%' }}>
                {questionWithShuffledOptions?.shuffledOptions.map((opt: any, i: any) => {
                  ...
                  return (
                    <label
                      key={opt.option}
                      className={`flex items-center justify-between min-w-1/4 m-2 space-x-3 cursor-pointer rounded-md border-[1px] border-gray-600 p-2`}
                      style={{
                        boxShadow:
                          isCorrect
                            ? "rgba(76, 175, 80, 0.2)"
                    ...
                    >
                      ...
                      <span className="text-md items-center w-full font-medium min-h-6 h-auto" style={{ color: "#000000", borderColor: "#000000" }}>
                        {opt.option}
                      </span>
